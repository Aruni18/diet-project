export default function Home(){
    ...
    <div className="container">
      ...
      <div className="row d-flex no-gutters">
        <div className="col-md-6 d-flex">
          <div
            className="img img-video d-flex align-self-stretch align-items-center justify-content-center justify-content-md-end mb-4 mb-sm-0"
        ...
        <div className="col-md-6 pl-md-5 py-md-5">
          ...
          <div className="services-2 w-100 d-flex">
            <div className="icon d-flex align-items-center justify-content-center">
              <span className="flaticon-skills" />
            </div>
            <div className="text pl-4">
          ...
          <div className="services-2 w-100 d-flex">
            <div className="icon d-flex align-items-center justify-content-center">
              <span className="flaticon-performance" />
            </div>
            <div className="text pl-4">
  ...
  <section className="ftco-section ftco-no-pb ftco-no-pt">
    <div className="container">
      <div className="row">
        <div className="col-md-12">
          <div className="bg-secondary w-100 rounded p-4">
            <div className="row">
